...
namespace OPBDSHKA
{
    public partial class adminCAB : Form
    {
        ...
        private void adminCAB_Load(object sender, EventArgs e)
        {
            ...
            string query = $"Select [Имя] from Агенты where [Код агента] = {usID}";
            ...
            string query2 = $"Select [Фамилия] from Агенты where [Код агента] = {usID}";
